...
export const projects: Project[] = [
  ...
  new Project(5, 'Factory', 'High-tech manufacturing facility.', 'https://res.cloudinary.com/djsl4a5py/image/upload/v1721454906/project5_qnn32b_11zon_v3v35u.webp', categories[2]),
